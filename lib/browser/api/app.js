...
const defaultRemoteRequireHandler = (contents, name) => process.mainModule.require(name)
const defaultRemoteGetGlobalHandler = (contents, name) => global[name]

app.remoteRequireHandler = defaultRemoteRequireHandler
app.remoteGetGlobalHandler = defaultRemoteGetGlobalHandler

app.setRemoteRequireHandler = function (handler) {
  app.remoteRequireHandler = handler || defaultRemoteRequireHandler
}

app.setRemoteGetGlobalHandler = function (handler) {
  app.remoteGetGlobalHandler = handler || defaultRemoteGetGlobalHandler
}
